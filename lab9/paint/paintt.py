...
def saveim(Surface, name):
    file = open('exist_check.txt', 'r')
    f = file.read()
    pygame.image.save(Surface ,r'C:/Users/kairb/Pictures/lab9.2' + name + str(int(f)) + '.png')
...
def main():
    ...
    icon = pygame.image.load(r'C:/Users/kairb/Pictures/lab9.2/icon.png')
    ...
    toolstxt = font.render('Tools:', True, BLACK)

    screen.blit(toolstxt, (910, 119))
    ...
    brushp= pygame.transform.scale(pygame.image.load(r"C:/Users/kairb/Pictures/lab9.2/brus.png"), (20,20))
    eraserp = pygame.transform.scale(pygame.image.load(r"C:/Users/kairb/Pictures/lab9.2/eras.png"), (20,20))
    clearp = pygame.transform.scale(pygame.image.load(r"C:/Users/kairb/Pictures/lab9.2/clea.png"), (30, 30))
    savep = pygame.transform.scale(pygame.image.load(r"C:/Users/kairb/Pictures/lab9.2/sav.png"), (98, 50))

    pygame.draw.rect(screen, BLACK, (918, 197, 25, 15), 2)
    pygame.draw.circle(screen, BLACK, (970, 205), 9, 2)

    global brus, eras, clea, sav
    save = screen.blit(savep, (902, 40))
    screen.blit(clearp, (936, 230)) 
    screen.blit(brushp, (920, 156))
    screen.blit(eraserp, (960, 158))
    colors_txt = font.render('Colors:', True, BLACK)
    screen.blit(colors_txt, (910, 450))
    pygame.draw.rect(screen, GREY, (925, 485, 50, 175), 2)
    collist = [RED, ORANGE, YELLOW, GREEN, POWDERBLUE, BLUE, PURPLE, BLACK]
    colrectlist = []
    for col, i in enumerate(range(485, 685, 25), 0):
        pygame.draw.rect(screen, collist[col], (925, i, 50, 25))
        colrectlist.append(pygame.Rect((925, i, 50, 25)))

    

    def size_buttons():
        global button
        siztxt = font.render('Size - ', True, BLACK)
        screen.blit(siztxt, (909, 298)) 
        pygame.draw.rect(screen, GREY, (910, 335, 80, 80), 2)
        screen.fill(WHITE, (912, 337, 77, 77))
        sizbtn = pygame.transform.scale(pygame.image.load(r"C:/Users/kairb/Pictures/lab9.2/up,down.png"), (25, 25))
        button = screen.blit(sizbtn, (970, 300))
        pygame.display.flip()
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.MOUSEBUTTONDOWN and event.button == 1:
                ...
                if mode == 'brush' or mode == 'rect' or mode == 'circle':
                    for i, col in enumerate(colrectlist, 0):
            ...
            if event.type == pygame.MOUSEMOTION:
                if draw_on:
                    if mode == 'brush' or mode == 'eraser':
                        drawline(draw_surf, last_pos, event.pos, radius, color)
                        screen.blit(draw_surf, (3, 3))
